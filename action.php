		...
		while($row = mysqli_fetch_array($run_query)){
			...
			<div class='card'>
					<div class='productName'>
						<p class='card-title'>$pro_title</p>
					</div>

					<div class='imgbtn'>
						<img class='cardImg'src='product_images/$pro_image' height: 50%;
						width: auto;>
					</div>
					...
					<div class='buybtn'>
						<button class='grbtn'><a class='text-white' href='https://api.whatsapp.com/send?phone=593990868506&text=Hola,%20Quisiera%20comprar%20el%20producto%0A$pro_title%0Apor%20\$$pro_price' target='_blank'>Comprar por Whatsapp</a></button>
					</div>
			</div>
...
if(isset($_POST["get_seleted_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["search"])){
	...
	while($row=mysqli_fetch_array($run_query)){
			...
			<div class='card'>
					...
					<div class='buybtn'>
						<button class='btn btn-success'><a class='text-white' href='>https://api.whatsapp.com/send?phone=593990868506&text=Hola,%20Quisiera%20comprar%20el%20producto%0A'.$pro_title.'%0A'.$pro_price'>Comprar por Whatsapp</a></button>
					</div>
			</div>
